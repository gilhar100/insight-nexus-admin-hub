...
export const exportGroupInsightsCSV = (
  ...
  if (workshopData) {
    ...
    if (wocaAnalysis?.groupZoneCounts) {
  ...
  const csvData = {
    // Basic group info
    group_number: templateData.groupNumber,
    participant_count: templateData.participantCount,
    
    // SALIMA data
    salimaScore: templateData.salimaScore.toFixed(2),
    strongestDimension_name: templateData.strongestDimension.name,
    strongestDimension_score: templateData.strongestDimension.score.toFixed(2),
    weakestDimension_name: templateData.weakestDimension.name,
    weakestDimension_score: templateData.weakestDimension.score.toFixed(2),
    ...
    wocaScore: templateData.wocaScore.toFixed(2),
