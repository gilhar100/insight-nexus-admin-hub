      ...
      {workshopData && wocaAnalysis && hasMinimumData && (
        <>
                  ...
                  <div className="mb-6">
                    ...
                    <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 ${isPresenterMode ? 'gap-8' : ''}`}>
                      <div className="text-center">
                        <div className={`font-bold ${isPresenterMode ? 'text-4xl' : 'text-2xl'}`} style={{ color: WOCA_ZONE_COLORS.opportunity }}>
                      ...
                      <div className="text-center">
                        <div className={`font-bold ${isPresenterMode ? 'text-4xl' : 'text-2xl'}`} style={{ color: WOCA_ZONE_COLORS.comfort }}>
                          {wocaAnalysis.groupCategoryScores.comfort.toFixed(1)}
                        </div>
                        <div className={`text-gray-600 ${isPresenterMode ? 'text-lg' : 'text-sm'}`}>נוחות</div>
                      </div>
                      <div className="text-center">
                        <div className={`font-bold ${isPresenterMode ? 'text-4xl' : 'text-2xl'}`} style={{ color: WOCA_ZONE_COLORS.apathy }}>
                          {wocaAnalysis.groupCategoryScores.apathy.toFixed(1)}
                        </div>
                        <div className={`text-gray-600 ${isPresenterMode ? 'text-lg' : 'text-sm'}`}>אדישות</div>
                      </div>
                      <div className="text-center">
                        <div className={`font-bold ${isPresenterMode ? 'text-4xl' : 'text-2xl'}`} style={{ color: WOCA_ZONE_COLORS.war }}>
          ...
          {!wocaAnalysis.groupIsTie && wocaAnalysis.groupDominantZone && (
            <ZoneDescription 
              zone={wocaAnalysis.groupDominantZone} 
