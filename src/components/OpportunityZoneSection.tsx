...
רק ארגון שפועל מתוך אזור ההזדמנות מסוגל לגבש חזון בהיר ומעורר השראה, ללמוד מכישלונות, לזהות הזדמנויות נסתרות – ולשוט לעבר ״האוקיינוסים הכחולים״, בשונה מ״האוקיינוסים האדומים״ בהם יש עימותים, מלחמות ומקיזים דם.

קיים מתאם חיובי בין היכולת להיות מנהל טרנספורמטיבי המדבר את שפת ה- ״SALIMA״, לבין ארגון הנמצא באזור ההזדמנות.
